...
and type_declaration i ppf x =
  with_location_mapping ~loc:x.ptype_loc ppf (fun () ->
...
and extension_constructor i ppf x =
  with_location_mapping ~loc:x.pext_loc ppf (fun () ->
...
and class_type i ppf x =
  with_location_mapping ~loc:x.pcty_loc ppf (fun () ->
...
and class_type_field i ppf x =
  with_location_mapping ~loc:x.pctf_loc ppf (fun () ->
...
and class_description i ppf x =
  with_location_mapping ~loc:x.pci_loc ppf (fun () ->
...
and class_expr i ppf x =
  with_location_mapping ~loc:x.pcl_loc ppf (fun () ->
...
and class_field i ppf x =
  with_location_mapping ~loc:x.pcf_loc ppf (fun () ->
...
and module_type i ppf x =
  with_location_mapping ~loc:x.pmty_loc ppf (fun () ->
...
and structure_item i ppf x =
  with_location_mapping ~loc:x.pstr_loc ppf (fun () ->
