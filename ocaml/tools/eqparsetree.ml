...
and labeled_eq_core_type : ((string option * core_type) * (string option * core_type)) -> 'result =
  fun
    ((lbl1, { ptyp_desc = a0; ptyp_loc = a1 }),
     (lbl2, { ptyp_desc = b0; ptyp_loc = b1 }))
    -> (eq_option eq_string (lbl1, lbl2)) &&  (eq_core_type_desc (a0, b0)) && (Location.eq_t (a1, b1))
